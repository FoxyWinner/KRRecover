...
public abstract class AbstractMultiDexContainer<T extends DexFile> implements MultiDexContainer<T> {
	...
	protected lanchon.multidexlib2.DuplicateEntryNameException duplicateEntryName(String entryName) {
		return new lanchon.multidexlib2.DuplicateEntryNameException(entryName);
	}
